...
//         </button>
//       </div>
//       <div className="mt-2 mb-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
...
//             <div className="relative flex" key={link}>
//               <img
//                 // key={index}
...
//               />
//               <button
//                 onClick={() => removePhoto(e, link)}
//                 className="  cursor-pointer absolute py-2 px-4 rounded-2xl bottom-4 right-4 bg-gray-900 bg-opacity-50 text-white hover: visible"
//               >
//                 <svg
//                   xmlns="http://www.w3.org/2000/svg"
//                   fill="none"
...
//               <button
//                 onClick={(e) => selectAsMainPhoto(e, link)}
//                 className=" cursor-pointer absolute py-2 px-4 rounded-2xl bottom-4 left-4 bg-gray-900 bg-opacity-50 text-white hover: visible"
//               >
//                 {link !== addedPhotos[0] && (
//                   <svg
//                     xmlns="http://www.w3.org/2000/svg"
